...
// ссылку из TelegramSettings.privacyPolicyUrl — прямо внутрь href, поэтому
// отправляется с parse_mode: 'HTML' (см. ensureConsentRequested), а не
// отдельной строкой со "голым" URL, как было раньше (Telegram разворачивал
// под ней большую карточку-предпросмотр Google Docs).
export const DEFAULT_CONSENT_TEXT =
  'Здравствуйте! \n' +
  'Это студия контента 2470🔥\n\n' +
  'Пока мы подключаем администратора, подтвердите, пожалуйста, ' +
  '<a href="{{privacy_policy_url}}">согласие на обработку персональных данных</a>. ' +
  'Администратор ответит вам в течение нескольких минут.'

export const DEFAULT_MANAGER_HANDOFF_MESSAGE = 'Отлично, администратор уже подключается к диалогу.'
