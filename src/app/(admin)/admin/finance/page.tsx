  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">Выручка, оплаты, долги, расходы и прибыль</p>
      </div>
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-14 text-center">
        ...
        <p className="text-zinc-500 text-sm mt-1.5 max-w-sm mx-auto">
          Здесь будет финансовая аналитика: выручка по периодам, оплаты, задолженности и статистика доходов
        </p>
      </div>
    </div>
  )
