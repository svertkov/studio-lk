  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">Хранилище файлов клиентов и проектов</p>
      </div>
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-14 text-center">
        <HardDrive className="w-10 h-10 text-zinc-600 mx-auto mb-4" />
        <p className="text-zinc-300 font-medium">Раздел в разработке</p>
        <p className="text-zinc-500 text-sm mt-1.5 max-w-sm mx-auto">
          Здесь будут все загруженные файлы с фильтрацией по клиентам, проектам и типам
        </p>
      </div>
    </div>
  )
