...
// "Сергей Зубарев / Леха Теселкин") — основной исполнитель первый, остальные
// текстом уходят в internalComment проекта (не создаём M2M-профили задним
// числом для гипотетического случая, которого нет в реальных 68 строках).
